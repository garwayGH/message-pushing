(function (global, factory) {
    ...
    var DEFAULT_FONT$1 = DEFAULT_FONT; // TODO: Have not support 'start', 'end' yet.
    ...
    each(['click', 'mousewheel', 'dblclick', 'contextmenu'], function (name) {
    ...
    */
    ...
    function getDataItemValue(dataItem) {
      return isObject$1(dataItem) && !isArray$1(dataItem) && !(dataItem instanceof Date) ? dataItem.value : dataItem;
    }
    /**
     * data could be [12, 2323, {value: 223}, [1221, 23], {value: [2, 23]}]
    ...
    function mappingToExists(exists, newCptOptions) {
      ...
      each$1(newCptOptions, function (cptOption, index) {
        if (!isObject$1(cptOption)) {
          return;
    ...
    function isIdInner(cptOption) {
      return isObject$1(cptOption) && cptOption.id && (cptOption.id + '').indexOf('\0_ec_\0') === 0;
    }
    /**
    ...
    * under the License.
    */
    function makeStyleMapper (properties) {
      // Normalize
    ...
    */
    ...
    Text.prototype = {
      ...
      brush: function (ctx, prevEl) {
        ...
        this.__dirty && normalizeTextStyle(style); // Use props with prefix 'text'.
    ...
    */
    ...
    function setLabelStyle(normalStyle, emphasisStyle, normalModel, emphasisModel, opt, normalSpecified, emphasisSpecified) {
      ...
      var emphasisStyleText = showEmphasis ? retrieve2(labelFetcher ? labelFetcher.getFormattedLabel(labelDataIndex, 'emphasis', null, labelDimIndex, labelProp) : null, baseText) : null; // Optimize: If style.text is null, text will not be drawn.
    ...
    */
    ...
    function getDependencies(componentType) {
      var deps = [];
      each(ComponentModel.getClassesByMainType(componentType), function (Clazz) {
    ...
    */
    ...
    function ExtensionAPI(chartInstance) {
      each(echartsAPIList, function (name) {
    ...
    */
    ...
    OptionManager.prototype = {
      ...
      setOption: function (rawOption, optionPreprocessorFuncs) {
        ...
        rawOption = clone$2(rawOption); // FIXME
      ...
      mountOption: function (isRecreate) {
        ...
        this._timelineOptions = map$1(optionBackup.timelineOptions, clone$2);
        this._mediaList = map$1(optionBackup.mediaList, clone$2);
      ...
      getTimelineOption: function (ecModel) {
        ...
        if (timelineOptions.length) {
          ...
          if (timelineModel) {
            option = clone$2(timelineOptions[timelineModel.getCurrentIndex()]);
          }
        }
    ...
    function parseRawOption(rawOption, optionPreprocessorFuncs, isNew) {
      ...
      if (rawOption.media) {
        ...
        each$3(media, function (singleMedia) {
      ...
      each$3([baseOption].concat(timelineOptions).concat(map(mediaList, function (media) {
        return media.option;
      })), function (option) {
    ...
    function mergeOption(oldOption, newOption) {
      newOption = newOption || {};
      each$3(newOption, function (newCptOpt, mainType) {
        if (newCptOpt == null) {
          return;
        }
    ...
    */
    ...
    function compatStyle (option, isTheme) {
      each$4(toArr(option.series), function (seriesOpt) {
        isObject$2(seriesOpt) && processSeries(seriesOpt);
      });
      var axes = ['xAxis', 'yAxis', 'radiusAxis', 'angleAxis', 'singleAxis', 'parallelAxis', 'radar'];
      isTheme && axes.push('valueAxis', 'categoryAxis', 'logAxis', 'timeAxis');
      each$4(axes, function (axisName) {
        each$4(toArr(option[axisName]), function (axisOpt) {
          if (axisOpt) {
      ...
      each$4(toArr(option.parallel), function (parallelOpt) {
        var parallelAxisDefault = parallelOpt && parallelOpt.parallelAxisDefault;
        compatTextStyle(parallelAxisDefault, 'axisLabel');
        compatTextStyle(parallelAxisDefault && parallelAxisDefault.axisPointer, 'label');
      });
      each$4(toArr(option.calendar), function (calendarOpt) {
      ...
      each$4(toArr(option.radar), function (radarOpt) {
        compatTextStyle(radarOpt, 'name');
      });
      each$4(toArr(option.geo), function (geoOpt) {
        if (isObject$2(geoOpt)) {
          compatEC3CommonStyles(geoOpt);
          each$4(toArr(geoOpt.regions), function (regionObj) {
            compatEC3CommonStyles(regionObj);
          });
        }
      });
      each$4(toArr(option.timeline), function (timelineOpt) {
      ...
      each$4(toArr(option.toolbox), function (toolboxOpt) {
        convertNormalEmphasis(toolboxOpt, 'iconStyle');
        each$4(toolboxOpt.feature, function (featureOpt) {
    ...
    */
    ...
    enableClassExtend(Chart); // Add capability of registerClass, getClass, hasClass, registerSubTypeDefaulter and so on.
    ...
    */
    ...
    var parseClassType$1 = ComponentModel.parseClassType;
    var version = '4.8.0';
    var dependencies = {
      zrender: '4.3.1'
    };
    ...
    echartsProto.getConnectedDataURL = function (opts) {
      ...
      if (connectedGroups[groupId]) {
        ...
        if (isSvg) {
          var content = '';
          each$5(canvasList, function (item) {
    ...
    echartsProto.containPixel = function (finder, value) {
      ...
      var result;
      finder = parseFinder(ecModel, finder);
      each(finder, function (models, key) {
    ...
    function updateDirectly(ecIns, method, payload, mainType, subType) {
      ...
      if (!mainType) {
        ...
        each$5(ecIns._componentsViews.concat(ecIns._chartsViews), callView);
        return;
      }
    ...
    function doDispatchAction(payload, silent) {
      ...
      cptType = cptType[0] != null && parseClassType$1(cptType[0]);
      this[IN_MAIN_PROCESS] = true;
    ...
    function prepareView(ecIns, type, ecModel, scheduler) {
      ...
      function doPrepare(model) {
        ...
        if (!view) {
          var classType = parseClassType$1(model.type);
    ...
    function performPostUpdateFuncs(ecModel, api) {
      each$5(postUpdateFuncs, function (func) {
        func(ecModel, api);
      });
    }
    ...
    echartsProto._initEvents = function () {
      ...
      each$5(eventActionMap, function (actionType, eventType) {
    ...
    echartsProto.dispose = function () {
      ...
      var api = this._api;
      var ecModel = this._model;
      each$5(this._componentsViews, function (component) {
        component.dispose(ecModel, api);
      });
      each$5(this._chartsViews, function (chart) {
    ...
    EventProcessor.prototype = {
      ...
      normalizeQuery: function (query) {
        ...
        if (isString(query)) {
          var condCptType = parseClassType$1(query); // `.main` and `.sub` may be ''.
      ...
      each$5(eventActionMap, function (actionType, eventType) {
        chart._messageCenter.on(eventType, function (event) {
          if (connectedGroups[chart.group] && chart[STATUS_KEY] !== STATUS_PENDING) {
            ...
            each$5(otherCharts, function (otherChart) {
    ...
    * under the License.
    */
    function createDataSelectAction (seriesType, actionInfos) {
      each(actionInfos, function (actionInfo) {
    ...
    */
    ...
    function labelLayout (seriesModel, r, viewWidth, viewHeight, viewLeft, viewTop) {
      var data = seriesModel.getData();
      var labelLayoutList = [];
      var cx;
      var cy;
    ...
    */
    ...
    function pieLayout (seriesType, ecModel, api, payload) {
      ecModel.eachSeriesByType(seriesType, function (seriesModel) {
        var data = seriesModel.getData();
        var valueDim = data.mapDimension('value');
